...
import Slide3Lifecycle from './components/Slide3Lifecycle'
import Slide4Analysis from './components/Slide4Analysis'
import Slide5Design from './components/Slide5Design'
import Slide6Part2Intro from './components/Slide6Part2Intro'
import Slide7ScalabilityAvailability from './components/Slide7ScalabilityAvailability'
import Slide8ReliabilityPerformance from './components/Slide8ReliabilityPerformance'
import Slide9MaintainabilitySecurity from './components/Slide9MaintainabilitySecurity'
import Slide10CostEfficiency from './components/Slide10CostEfficiency'
import Slide11BackendRole from './components/Slide11BackendRole'
import Slide12QueryCaseStudy from './components/Slide12QueryCaseStudy'
import Slide13Part3Summary from './components/Slide13Part3Summary'
import Slide14TaleOfTwoTeams from './components/Slide14TaleOfTwoTeams'
import Slide15Conclusion from './components/Slide15Conclusion'
        ...
        {isOverview ? (
          ...
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 p-4 animate-fade-in">
            ...
            >
              ...
              <h3 className="font-display font-bold text-lg leading-tight mb-2">SYSTEM ANALYSIS & DESIGN</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Thinking beyond code to build scalable, reliable, and cost-effective systems.</p>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 3 — SDLC</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">The Professional Lifecycle</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Contrasting the developer myth with the professional software lifecycle steps.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">SDLC</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 4 — Analysis</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">Asking the Right Questions</h3>
              <p className="text-xs text-slate-400 line-clamp-2">How to analyze problems and requirements using a WhatsApp messaging platform example.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">Analysis</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 5 — Design</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">Designing the Machine</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Architecting structural solutions and defining architectural components before coding.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">Design</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 6 — Part 2 Intro</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">What Makes a Good System?</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Overview of the 7 qualities every great system must have.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">Part 2</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 7 — Scale & Uptime</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">Scalability & Availability</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Can it grow? Is it online when users need it?</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">Scalability</span>
                <span className="text-[9px] bg-blue-950 text-blue-300 px-1.5 py-0.5 rounded">Availability</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 8 — Trust & Speed</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">Reliability & Performance</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Does it always work? How fast does it respond?</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-violet-950 text-violet-300 px-1.5 py-0.5 rounded">Reliability</span>
                <span className="text-[9px] bg-yellow-950 text-yellow-300 px-1.5 py-0.5 rounded">Performance</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 9 — Code & Shield</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">Maintainability & Security</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Can developers understand it? Can attackers break it?</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-cyan-950 text-cyan-300 px-1.5 py-0.5 rounded">Maintainability</span>
                <span className="text-[9px] bg-red-950 text-red-300 px-1.5 py-0.5 rounded">Security</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-lime-400 uppercase tracking-wider block mb-1">Slide 10 — The Most Ignored</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">Cost Efficiency</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Technically beautiful, financially catastrophic — the lesson most developers skip.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-lime-950 text-lime-300 px-1.5 py-0.5 rounded">Cost</span>
              </div>
            </div>
            ...
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 11 — Backend Role (Pt.3)</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">You Control the Cost Center</h3>
              <p className="text-xs text-slate-400 line-clamp-2">The 6 backend decisions that directly drive infrastructure cost.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">Part 3</span>
              </div>
            </div>
            ...
            <div
              ...
              className={`cursor-pointer rounded-xl p-5 border-2 text-left transition-all hover:scale-[1.02] ${currentSlide === 11 ? 'border-emerald-500 bg-emerald-950/20' : 'border-white/10 bg-black/20 hover:border-white/20'}`}
            >
              <span className="text-xs font-semibold text-yellow-400 uppercase tracking-wider block mb-1">Slide 12 — Query Case Study</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">One Query. Two Outcomes.</h3>
              <p className="text-xs text-slate-400 line-clamp-2">SELECT * disaster vs optimized query — real cost consequences shown side by side.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-red-950 text-red-300 px-1.5 py-0.5 rounded">SELECT *</span>
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">Optimized</span>
              </div>
            </div>
            ...
            <div
              ...
              className={`cursor-pointer rounded-xl p-5 border-2 text-left transition-all hover:scale-[1.02] ${currentSlide === 12 ? 'border-emerald-500 bg-emerald-950/20' : 'border-white/10 bg-black/20 hover:border-white/20'}`}
            >
              <span className="text-xs font-semibold text-lime-400 uppercase tracking-wider block mb-1">Slide 13 — Part 3 Summary</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">Think Like an Architect</h3>
              <p className="text-xs text-slate-400 line-clamp-2">4 key rules backend developers must internalize to build cost-effective, scalable systems.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-lime-950 text-lime-300 px-1.5 py-0.5 rounded">Summary</span>
              </div>
            </div>
            ...
            <div
              ...
              className={`cursor-pointer rounded-xl p-5 border-2 text-left transition-all hover:scale-[1.02] ${currentSlide === 13 ? 'border-emerald-500 bg-emerald-950/20' : 'border-white/10 bg-black/20 hover:border-white/20'}`}
            >
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider block mb-1">Slide 14 — Two Teams (Pt.4)</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">A Tale of Two Teams</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Tale of Team A vs Team B detailing why architecture directly impacts monthly server costs.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-emerald-950 text-emerald-300 px-1.5 py-0.5 rounded">Part 4</span>
              </div>
            </div>
            ...
            <div
              ...
              className={`cursor-pointer rounded-xl p-5 border-2 text-left transition-all hover:scale-[1.02] ${currentSlide === 14 ? 'border-emerald-500 bg-emerald-950/20' : 'border-white/10 bg-black/20 hover:border-white/20'}`}
            >
              <span className="text-xs font-semibold text-lime-400 uppercase tracking-wider block mb-1">Slide 15 — Conclusion</span>
              <h3 className="font-display font-bold text-lg leading-tight mb-2">The Architect Mindset</h3>
              <p className="text-xs text-slate-400 line-clamp-2">Key takeaway summaries of Systems Academy presentation.</p>
              <div className="mt-4 flex gap-1.5">
                <span className="text-[9px] bg-lime-950 text-lime-300 px-1.5 py-0.5 rounded">Wrap-up</span>
              </div>
            </div>
          ...
          >
            ...
            {/* SLIDE 3: SDLC PROCESS */}
            {currentSlide === 2 && <Slide3Lifecycle s={s} />}

            {/* SLIDE 4: SYSTEM ANALYSIS */}
            {currentSlide === 3 && <Slide4Analysis s={s} />}

            {/* SLIDE 5: SYSTEM DESIGN */}
            {currentSlide === 4 && <Slide5Design s={s} />}

            {/* SLIDE 6: PART 2 INTRO */}
            {currentSlide === 5 && <Slide6Part2Intro s={s} />}

            {/* SLIDE 7: SCALABILITY & AVAILABILITY */}
            {currentSlide === 6 && <Slide7ScalabilityAvailability s={s} />}

            {/* SLIDE 8: RELIABILITY & PERFORMANCE */}
            {currentSlide === 7 && <Slide8ReliabilityPerformance s={s} />}

            {/* SLIDE 9: MAINTAINABILITY & SECURITY */}
            {currentSlide === 8 && <Slide9MaintainabilitySecurity s={s} />}

            {/* SLIDE 10: COST EFFICIENCY */}
            {currentSlide === 9 && <Slide10CostEfficiency s={s} />}

            {/* SLIDE 11: BACKEND ROLE */}
            {currentSlide === 10 && <Slide11BackendRole s={s} />}

            {/* SLIDE 12: QUERY CASE STUDY */}
            {currentSlide === 11 && <Slide12QueryCaseStudy s={s} />}

            {/* SLIDE 13: PART 3 SUMMARY */}
            {currentSlide === 12 && <Slide13Part3Summary s={s} />}

            {/* SLIDE 14: TALE OF TWO TEAMS */}
            {currentSlide === 13 && <Slide14TaleOfTwoTeams s={s} />}

            {/* SLIDE 15: CONCLUSION */}
            {currentSlide === 14 && <Slide15Conclusion s={s} />}
        ...
        <div className="fixed inset-y-0 right-0 w-80 bg-[#0b0e17] border-l border-white/10 z-50 p-6 shadow-2xl flex flex-col justify-between animate-slide-in-right">
          <div>
            ...
            <div className="flex flex-col gap-2">
              {[
                { label: 'Slide 1: Cover Page', desc: 'System Analysis & Design Introduction' },
                { label: 'Slide 2: About Presenter', desc: 'Daniel Turu, CEO & Dev' },
                { label: 'Slide 3: Professional SDLC', desc: 'Amateur vs Professional Lifecycles' },
                { label: 'Slide 4: System Analysis', desc: 'Asking the Right Questions' },
                { label: 'Slide 5: System Design', desc: 'Blueprinting the Machine' },
                { label: 'Slide 6: Good System? (Pt.2)', desc: '7 Qualities Every System Must Have' },
                { label: 'Slide 7: Scale & Uptime', desc: 'Scalability & Availability' },
                { label: 'Slide 8: Trust & Speed', desc: 'Reliability & Performance' },
                { label: 'Slide 9: Code & Shield', desc: 'Maintainability & Security' },
                { label: 'Slide 10: Cost Efficiency', desc: 'The Most Ignored Quality' },
                { label: 'Slide 11: Backend Role (Pt.3)', desc: 'You Control the Cost Center' },
                { label: 'Slide 12: Query Case Study', desc: 'SELECT * vs Optimized — Real Cost' },
                { label: 'Slide 13: Think Like Architect', desc: '4 Rules Every Backend Dev Must Know' },
                { label: 'Slide 14: Two Teams (Pt.4)', desc: 'Tale of Two Teams & Cost Impact' },
                { label: 'Slide 15: The Architect Mindset', desc: 'Presentation Conclusion' },
              ].map((item, idx) => (
                <button
                  key={idx}
          ...
          <div className="border-t border-white/10 pt-4 text-left">
            <span className="text-[10px] text-slate-500 block uppercase tracking-wider font-bold">Instructor:</span>
            <span className="text-xs text-slate-300 font-medium block">Daniel Turu</span>
            <span className="text-[10px] text-emerald-500/80 font-bold block mt-1">System Architecture for Developers</span>
          </div>
        </div>
      )}
